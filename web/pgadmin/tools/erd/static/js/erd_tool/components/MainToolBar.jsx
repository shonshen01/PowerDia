...
import { MagicIcon } from '../../../../../../static/js/components/ExternalIcon';
  ...
  return (
    (<>
      <StyledBox>
        ...
        {/* PowerDia: Load Network Hierarchy */}
        <PgButtonGroup size="small">
          <PgIconButton
            title={gettext('Load Network Hierarchy')}
            icon={<i className="fa fa-sitemap" style={{fontSize: '1rem'}} />}
            onClick={() => {
              eventBus.fireEvent(ERD_EVENTS.LOAD_NETWORK);
            }}
          />
        </PgButtonGroup>
      </StyledBox>
