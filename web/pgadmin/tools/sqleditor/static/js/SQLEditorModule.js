...
export default class SQLEditor {
  ...
  */
  ...
  showQueryTool(url, treeIdentifier, sqlId, is_new_tab, macroSQL) {
    const transId = commonUtils.getRandomInt(1, 9999999);
    ...
    if (preference.value && !d._type.includes('coll-') && (url === '' || url['applies'] === 'tools') && !macroSQL) {
      ...
      showQueryTool.showQueryTool(this, pgBrowser, url, treeIdentifier, transId, sqlId, is_new_tab, macroSQL);
    }
  }
