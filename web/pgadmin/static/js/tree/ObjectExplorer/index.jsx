...
export default function ObjectExplorer() {
  ...
  // PowerDia: Right-click context menu disabled globally for all tree nodes.
  // ev.preventDefault() suppresses the native browser context menu.
  // setContextPos is intentionally NOT called, so the pgAdmin menu never opens.
  const onContextMenu = React.useCallback((ev) => {
    ev.preventDefault();
  }, []);
