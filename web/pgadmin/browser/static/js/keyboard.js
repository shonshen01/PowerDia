    ...
    usePreferences.subscribe((prefStore) => {
      ...
      if (prefStore.version > 0) {
        this.keyboardShortcut = {
          ...
          'sub_menu_macros': commonUtils.parseShortcutValue(prefStore.getPreferences('browser', 'sub_menu_macros')?.value),
        ...
        this.shortcutMethods = {
          ...(prefStore.getPreferences('browser', 'main_menu_file')?.value) && {
            'bindMainMenu': {
          ...
          'bindSubMenuMacros': { 'shortcuts': this.keyboardShortcut.sub_menu_macros }, // Sub menu - Open Macros Menu,
